...
## The below steps helps you to create VPC through Github actions

Step 1: Create a directory under the root folder with the name '.github/workflows' , name it "create_vpc"
